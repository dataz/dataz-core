 ...
 * duplicated template objects (same name associated to the same dataset).
 */
public enum TemplateObjectDuplicateStrategy implements DuplicateHandler, TemplateObjectCreatorListOrder {
    /**
    ...
    OVERWRITE {
        @Override
        public List<TemplateObjectCreator> order(List<TemplateObjectCreator> templateObjectCreatorList) {
