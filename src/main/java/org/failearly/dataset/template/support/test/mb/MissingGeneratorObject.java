...
/**
 * MissingGeneratorObject is responsible for ...
 */
final class MissingGeneratorObject extends TemplateObjectMessageBuilder {
    public MissingGeneratorObject(MessageBuilder mb) {
        super(mb);
    }
    ...
    protected TemplateObjectMessageBuilder actions() {
        // TODO: Implement MissingGeneratorObject#actions
        if(true) throw new UnsupportedOperationException("MissingGeneratorObject.actions() not yet implemented");
        return this;
    }
}
