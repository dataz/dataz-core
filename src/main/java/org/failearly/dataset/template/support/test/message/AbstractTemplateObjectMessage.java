...
import static org.failearly.dataset.template.support.test.message.AbstractTemplateObjectMessage.ARG_TEST_CLASS;
...
abstract class AbstractTemplateObjectMessage<T extends AbstractTemplateObjectMessage<T>>
    ...
    static final String ARG_TEMPLATE_OBJECT_FACTORY    = "TOF";
    static final String ARG_TEMPLATE_OBJECT_ANNOTATION = "TOA";
    static final String ARG_TEST_FIXTURE = "tf";
    static final String ARG_TEMPLATE_OBJECT = "TO";

    static final String ARG_TEST_CLASS = "tc";
    ...
    AbstractTemplateObjectMessage(Class<T> messageBuilderClass) {
