...
/**
 * This package contains some standard {@link org.failearly.dataset.generator.support.Generator} annotations.
 * <br><br>
 ...
 *    {@literal @}{@link org.failearly.dataset.generator.ListGenerator}(name="fname", dataset="DS1", values={"Smith","Miller","White","Heisenberg"})
 *    {@literal @}{@link org.failearly.dataset.generator.ListGenerator}(name="cname", dataset="DS1", values={"Frank","Walter","Skyla"})
 *    {@literal @}{@link org.failearly.dataset.generator.RandomRangeGenerator}(name="ids", dataset="DS1", unique=true, seed=1, end=100_000)
 *    public class MyTest {
 *        // ... omitted for brevity
 *    }
 * </pre>
