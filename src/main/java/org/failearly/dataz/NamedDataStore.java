 ...
 * one DataStore annotation (for example {@code SqlDataStore} or {@link AdhocDataStore}), for each annotation,
 * DataZ will create a {@link DataStore} instance - this could be useful for running tests multithreaded.
 *
 * **Remarks**:
 *
