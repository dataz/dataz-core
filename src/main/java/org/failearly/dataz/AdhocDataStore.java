...
public @interface AdhocDataStore {
    ...
    /**
     * If you use multiple datastore definition, you must explicit set the type. The default implementation uses the
     * property {@link Constants#DATAZ_PROPERTY_DATASTORE_TYPE_CLASS_NAME}, which will be set in
     * {@link Constants#DATAZ_DATASTORE_PROPERTY_FILE} of each module.
     *
     * @return the {@link org.failearly.dataz.datastore.DataStoreType} class.
     ...
     * If not specified the value of {@link Constants#DATAZ_PROPERTY_DEFAULT_SETUP_SUFFIX}
     * will be used.
     * <br><br>
     * Example:<br><br>
     * <pre>
    ...
    /**
     * Analog to {@link #setupSuffix()}. If not specified, the value of {@link Constants#DATAZ_PROPERTY_DEFAULT_CLEANUP_SUFFIX}
     * will be used.
     *
