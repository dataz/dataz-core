...
/**
 * Sometimes a {@link org.failearly.dataz.datastore.DataStore} needs some initial settings before any test could access the datastore and cleaning after all
 * tests (of an entire test run).
 * <br><br>
 * The resources of {@code DataStoreSetup} will be <em>applied only once</em> per {@link org.failearly.dataz.datastore.DataStore#getId()}.
 * <br><br>
 * Similar to a {@link org.failearly.dataz.DataSet}, but should be used for DataStore setup or cleanup, like creating schemes or
 * master data, which won't be manipulated at all.
 *
 * @see org.failearly.dataz.datastore.DataStore#setupDataStore(java.util.List, org.failearly.dataz.internal.template.TemplateObjects)
 * @see org.failearly.dataz.datastore.DataStore#cleanupDataStore()
 *
