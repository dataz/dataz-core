...
import org.failearly.dataz.test.DefaultFakeDataStore;
...
public class DataSetRuleTest {
    ...
    public void missing_setup_resource__should_result_in_error() throws Throwable {
        ...
        // assert / then
        ExceptionVerifier.on(newStatement::evaluate).expect(DataStoreException.class).expect("Can't open resource '/org/failearly/dataz/junit4/unknown.setup'. Did you create the resource within classpath?").verify();
    }
