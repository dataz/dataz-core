...
public class IntegrateAllTest {
    ...
    public static void setDefaultSuffix() throws Exception {
        DataSetProperties.setProperty(Constants.DATAZ_PROPERTY_DEFAULT_SETUP_SUFFIX, "setup.vm");
        DataSetProperties.setProperty(Constants.DATAZ_TEMPLATE_OBJECT_DUPLICATE_STRATEGY, "IGNORE");
    }
