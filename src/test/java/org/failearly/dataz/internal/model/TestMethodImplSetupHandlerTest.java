...
public class TestMethodImplSetupHandlerTest extends TestMethodImplTestBase {
    ...
    public void only_current_test_method__should_be_applied() throws Exception {
        ...
        // act / when
        testMethod.handleSetupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, defaultResourceHandler);
    ...
    public void method_with_annotation_DataSet__on_test_class_hierarchy() throws Exception {
        ...
        // assert / then
        assertDataResources(                                                                                     //
                isDataResource("DS5", "/org/failearly/dataz/internal/model/BaseTestClass.setup")            //
                , isDataResource("DS3", "/org/failearly/dataz/internal/model/DS31.setup")                   //
                , isDataResource("DS3", "/DS32.setup")                                                        //
                , isDataResource("DS4", "/org/failearly/dataz/internal/model/TestClassHierarchy.setup")              //
                , isDataResource("DS1", "/org/failearly/dataz/internal/model/DS11.setup")                   //
                , isDataResource("DS1", "/DS12.setup")                                                        //
                , isDataResource("DS2", "/org/failearly/dataz/internal/model/TestClassHierarchy-withDataSet.setup")  //
        );
    }
    ...
    public void method_with_annotation_DataSet__on_different_datastore() throws Exception {
        ...
        // assert / then
        assertDataResources( //
                DataResourceMatchers.isDataResource("OTHER-DATASTORE", "DS6", "/org/failearly/dataz/internal/model/TestClassHierarchy.setup") //
        );
    }
    ...
    public void normal_junit_test_class() throws Exception {
        ...
        testMethod.handleSetupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, resourceHandler);
    ...
    public void simpleDataSet_setup_without_annotation_DataSet() throws Exception {
        ...
        assertDataResources( //
                isDataResource("DS1", "/org/failearly/dataz/internal/model/DS11.setup") //
                , isDataResource("DS1", "/org/failearly/dataz/internal/model/DS12.setup") //
                , isDataResource("DS3", "/org/failearly/dataz/internal/model/SimpleDataSetTestClass.setup") //
        );
    }
    ...
    public void simpleDataSet_setup_with_annotation_DataSet() throws Exception {
        ...
        assertDataResources( //
                ...
                , isDataResource("DS1", "/org/failearly/dataz/internal/model/DS12.setup") //
                , isDataResource("DS3", "/org/failearly/dataz/internal/model/SimpleDataSetTestClass.setup") //
                , isDataResource("DS2", "/org/failearly/dataz/internal/model/DS2.setup") //
                , isDataResource("DS4", "/org/failearly/dataz/internal/model/SimpleDataSetTestClass-withDataSet.setup") //
        );
    }
    ...
    public void simpleDataSet_setup_with_mixed_dataset_annotations() throws Exception {
        ...
        assertDataResources( //
                ...
                , isDataResource("DS1", "/org/failearly/dataz/internal/model/DS12.setup") //
                , isDataResource("DS3", "/org/failearly/dataz/internal/model/SimpleDataSetTestClass.setup") //
                , isDataResource("DSP2", "/org/failearly/dataz/internal/model/SimpleDataSetTestClass-withDataSetupAndDataSet.setup")// DataSetup(name=DSP2)
                , isDataResource("DS5", "/org/failearly/dataz/internal/model/SimpleDataSetTestClass-withDataSetupAndDataSet.setup") // DataSet(name=DS5)
        );
    }
