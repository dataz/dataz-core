...
public class TestClassTest {
    ...
    public void resolveSetupResourceNames() throws Exception {
        ...
        assertThat("Setup Resource Names?", resourceNames, contains(
                        "/com/company/project/DataSetBaseClass.setup",
                        "/com/company/project/module/MiddleDataSetBaseClass.setup",
                        "/org/failearly/dataz/internal/model/AnyTestClass.setup",
                        "/org/failearly/dataz/internal/model/testWithDataSet1.setup",
                        "/testWithDataSet2.setup",
                        "/org/failearly/dataz/internal/model/AnyTestClass-testWithDataSet.setup"
                )
        );
    }
    ...
    public void resolveCleanupResourceNames() throws Exception {
        ...
        assertThat("Cleanup Resource Names?", resourceNames, contains(
                        "/org/failearly/dataz/internal/model/testWithDataSet2.cleanup",
                        "/org/failearly/dataz/internal/model/AnyTestClass-testWithDataSet.cleanup",
                        "/org/failearly/dataz/internal/model/AnyTestClass.cleanup",
                        "/middle2.cleanup",
    ...
    private List<String> resolveCleanupResourceNames(String methodName) {
        ...
        this.testClass.getTestMethod(methodName).handleCleanupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, (m, d, dataResource) -> resourceNames.add(dataResource.getResource()));
        return resourceNames;
    }

    private List<String> resolveSetupResourceNames(String methodName) {
        final List<String> resourceNames = new LinkedList<>();
        this.testClass.getTestMethod(methodName).handleSetupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, (m, d, dataResource) -> resourceNames.add(dataResource.getResource()));
        return resourceNames;
    }
    ...
    @DataSet(name = "AnyTestClass", setup = "AnyTestClass.setup")
    ...
    private static class AnyTestClass extends MiddleDataSetBaseClass {
        ...
        @Test
        @DataSet(name = "testWithDataSet", setup = {"testWithDataSet1.setup", "/testWithDataSet2.setup"})
