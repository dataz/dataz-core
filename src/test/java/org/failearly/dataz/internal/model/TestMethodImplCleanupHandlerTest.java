...
public class TestMethodImplCleanupHandlerTest extends TestMethodImplTestBase {
    ...
    public void only_current_test_method_should_be_applied() throws Exception {
        ...
        // act / when
        testMethod.handleCleanupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, defaultResourceHandler);
    ...
    public void method_with_annotation_DataSet__on_different_datastore() throws Exception {
        ...
        // assert / then
        assertDataResources(
                DataResourceMatchers.isDataResource("OTHER-DATASTORE", "DS6", "/org/failearly/dataz/internal/model/TestClassHierarchy.cleanup")
        );
    }
    ...
    public void method_with_annotation_DataSet() throws Exception {
        ...
        // assert / then
        assertDataResources(  //
                isDataResource("DS2", "/org/failearly/dataz/internal/model/TestClassHierarchy-withDataSet.cleanup"), //
                isDataResource("DS1", "/DS12.cleanup"), //
                isDataResource("DS1", "/org/failearly/dataz/internal/model/DS11.cleanup"), //
                isDataResource("DS4", "/org/failearly/dataz/internal/model/TestClassHierarchy.cleanup"), //
                isDataResource("DS3", "/DS32.cleanup"), //
                isDataResource("DS3", "/org/failearly/dataz/internal/model/DS31.cleanup"), //
                isDataResource("DS5", "/org/failearly/dataz/internal/model/BaseTestClass.cleanup") //
        );
    }
    ...
    public void normal_junit_test_class() throws Exception {
        ...
        // act / when
        testMethod.handleCleanupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, resourceHandler);
    ...
    public void suppressed_cleanup_annotation__should_never_call_handleCleanupResource() throws Exception {
        ...
        on(() -> suppressCleanup.handleCleanupResource(Constants.DATAZ_DEFAULT_DATASTORE_ID, defaultResourceHandler))
