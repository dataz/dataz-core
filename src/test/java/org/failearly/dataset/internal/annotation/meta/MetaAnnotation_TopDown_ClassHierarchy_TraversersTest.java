 ...
 */
public class MetaAnnotation_TopDown_ClassHierarchy_TraversersTest extends AnnotationTraversersTestBase<Annotation> {

    private final AnnotationTraverser<Annotation> topDownClassHierarchyTraverser = AnnotationTraversers.createMetaAnnotationTraverser(
    ...
    public void traverse_on_simple_class_using_single_annotation__should_return_only_the_class_annotation() throws Exception {
        ...
        // assert / then
        assertAnnotations("@org.failearly.dataset.internal.annotation.meta.UsingMetaAnnotation(name=UseOnlyOneAnnotation)");
    }
    ...
    public void traverse_on_simple_method_using_single_annotation__should_return_only_the_method_and_class_annotations() throws Exception {
        ...
        // assert / then
        assertAnnotations(
                "@org.failearly.dataset.internal.annotation.meta.UsingMetaAnnotation(name=UseOnlyOneAnnotation.anyMethod)",    //
                "@org.failearly.dataset.internal.annotation.meta.UsingMetaAnnotation(name=UseOnlyOneAnnotation)" //
        );
    }
